...
public class AlphaFragment extends Fragment implements PhotoAdapter.OnPhotoClickListener {
    ...
    private List<Integer> createPhotoList() {
        TypedArray photoArray = getResources().obtainTypedArray(R.array.alpha_array);
